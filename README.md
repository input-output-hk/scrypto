...
```scala
libraryDependencies += "org.scorexfoundation" %% "scrypto" % "1.2.1"
```
...
or just
```scala
val myHashChain = hashChain(Blake512, BMW512, Groestl512, Skein512, JH512, Keccak512, Luffa512, Whirlpool)
```
