...
/**
  ...
  */
case class BatchAVLProver[HF <: ThreadUnsafeHash](o: Option[AVLKey]=None/*TODO: THIS ARGUMENT IS NOT USED*/, keyLength: Int = 32,
  ...
  private var topNode: ProverNodes = new ProverLeaf(NegativeInfinityKey,
